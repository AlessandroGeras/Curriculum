...
const Skills = () => {
  ...
  const certificationsReducer = useSelector(
    (state) => state.certificationReducer.certifications
  );
  const bootcampsReducer = useSelector(
    (state) => state.bootcampReducer.bootcamps
  );
  ...
  return (
    <div>
      <BackGround>
          ...
          {projectsReducer.map((projectitemlist, projectitemlistindex) => (
            <div key={projectitemlistindex}>
              ...
              <article>
                ...
                <br />
                {projectitemlist.live !== "null" && (
                  <div>
                    <h5>
                      Ver Projeto Online:{" "}
                      <a href={projectitemlist.live} target="_blank">
                        Link
                      </a>
                    </h5>
                  </div>
              ...
              {projectitemlist.linkfrontend !== "null" && (
                <div>
                  <h5>
                    Frontend Files:{" "}
                    <a href={projectitemlist.linkfrontend} target="_blank">
                      Link
                    </a>
                  </h5>
                </div>
                ...
                {projectitemlist.linkbackend !== "null" && (
                  <div>
                    <h5>
                      Backend Files:{" "}
                      <a href={projectitemlist.linkbackend} target="_blank">
                        Link
                      </a>
                    </h5>
                  </div>
        ...
        <Certifications>
          {certificationsReducer.map(
            (certificationitemlist, certificationitemlistindex) => (
              <div key={certificationitemlistindex}>
                ...
                <article className={certificationitemlist.category}>
                  ...
                  <a
                    className="certificado"
                    href={certificationitemlist.link}
                    target="_blank"
                  >
                    Certificado
                  </a>
...
const BackGround = styled.div`
  background-image: linear-gradient(
    ...
    linear-gradient(90deg, rgb(156, 174, 7), rgb(129, 53, 44));
